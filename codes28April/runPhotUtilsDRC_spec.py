...
def runPhotUtils(drcInfo,radius=4,suffix='_pu.dat',date=dateDef_):
    ...
    fileNames = ['../PEGASUS-III_f606w/final_drcF606W',
                 '../PEGASUS-III_f814w/final_drcF814W',
                 '../PISCES-II_f606w/final_drcF606W',
                 '../PISCES-II_f814w/final_drcF814W']

    ffNames = ['PEGASUS-III', 'PEGASUS-III',
               'PISCES-II', 'PISCES-II']
    ...
    for ff in range(len(info)):
        ...
        outName = saveDir + ffNames[ff] + '_' + filt
...
# We kept track of whether a given source's magnitude in the four- and
# six-pixel radii was within 1.5 standard deviations of the median difference
# across all sources to create a flag differentiating likely stars from other
# sources. Well-behaved, star-like sources would have positive magnitude
# differences between the four- and six-pixel radius, and were flagged as real.
        ...
        ax.set_ylim(median-1.5 * std,median+1.5 * std)
