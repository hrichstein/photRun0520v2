""" Trying to get around dumb naming conventions I had """

import numpy as np
from scipy import stats
import matplotlib.pyplot as plt

def dummygetZPT(targname,filt,dir='./',sigTol=2.5,stdTol=0.1):
...
def doZPT(targname,filt,dir='./',sigTol=2.5,stdTol=0.1):
    ...
    applyZPT(0, 0, 0, 0, 0,0,targname,filt,dir='./photUtils28Sep/catDir_'+targname+'/')
    return None
#
