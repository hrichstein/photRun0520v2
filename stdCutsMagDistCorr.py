...
def makeSTDcuts(dir,targname,filt,suffix='_aftLT.dat',saveFile=None):
    ...
    save.write("%s %s %f" % (targname, filt, cor))
    save.close()
    ...
    form +='%1.4f %1.4f %1.4f %1.4f %1.4f %1.4f %1.4f %1.4f %1.4f %1.4f '
    form +='%1.4f %1.4f %1.4f %1.5f %d %d %d'

    np.savetxt(dir+'magSTDcutAll_'+filt+'_mDc.dat',data,header=header,fmt=form)
