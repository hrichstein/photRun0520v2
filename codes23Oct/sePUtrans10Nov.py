...
def main():
    ref_file = '../drcPhot02Nov/sePU10Nov/sePUdrcRef.dat'
    all_file = '../drcPhot02Nov/HOROLOGIUM-I_newFlag.dat'
    save_dir = '../drcPhot02Nov/sePU10Nov/'
    tname= 'HOROLOGIUM-I'

    linTransSEpu(tname, refFile=ref_file, allFile=all_file,
                 saveDir=save_dir)
...
def linTransSEpu(targname, refFile='None.dat', allFile='None.dat',
    ...
    header += ' xSEf814w ySEf814w'  # adding new column names; make sure
