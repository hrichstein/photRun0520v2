...
def linAPERTrans(targname,dir='photUtils0820/'):
    ...
    file = np.genfromtxt(dir+'flcAPERref_'+targname+'_1408.dat',names=True)
    fileCat = np.genfromtxt(dir+'flcAPERref_'+targname+'_1408.dat')
    ...
    outName = dir + targname + "_APER2flcTrans"
    ...
    new_match[:,0],new_match[:,1],master_arr[:,0], master_arr[:,1],label_1='Original in APER',label_2='New in APER 2 FLC',label_3='Original in FLC',outname=outName+'_matchCheck')
