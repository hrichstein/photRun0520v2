...
def makeCMD(targname,dir='./'):
    ...
    ax1.scatter(match['m606c']-match['m814c'],match['m606c'],s=5,label='PSF')
    ax1.scatter(match['magZPT_f606w']-match['magZPT_f814w'],match['magZPT_f606w'],s=5,label='FLC')

    ax2.scatter(match['m606c']-match['m814c'],match['m814c'],s=5,label='PSF')
    ...
    plt.savefig(dir+targname+'_PSFflc.png',dpi=600,bbox_inches='tight')
