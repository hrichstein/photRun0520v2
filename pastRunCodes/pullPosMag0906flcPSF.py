...
master= np.genfromtxt(dir+'flcPSF_idx_0906.dat')
...
header= 'RA DEC flags c_star mag1 mag2 mag3 mag4 xt1 yt1 magZPT magZPTerr xPSF_trans yPSF_trans xPSF_mas yPSF_mas magPSF id_cat'

np.savetxt(dir+'matchedFLCpsf0906.dat',outArr,header=header)
