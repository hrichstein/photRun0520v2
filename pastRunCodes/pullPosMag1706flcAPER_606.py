...
master= np.genfromtxt(dir+'flcPSF_idx_1706_f606wAPER.dat')
...
header= 'RA DEC flags c_star mag1 mag2 mag3 mag4 xr1 yr1 xt1 yt1 magZPT magZPTerr xAPER_trans yAPER_trans xAPER_mas yAPER_mas magAPER id_cat'

np.savetxt(dir+'matchedFLCaper1706_606.dat',outArr,header=header)
