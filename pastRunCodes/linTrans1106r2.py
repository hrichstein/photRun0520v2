...
# matched_w_MagsPos2705.dat
    match = np.loadtxt(dir+"matched_w_MagsPos1106.dat")
    master = np.loadtxt(dir+"matched_w_MagsPos1106.dat")
    ...
    for ff in range(len(jdanUse)):
        ...
        outname = jdanUse[ff]+"_"+targname+"_"+filt+"_t_1106r2.dat"
...
def addTranscols(targname,filt,dir='catRawMags1305/catDir/'):
    ...
    for ff in range(len(jdanUse)):
        ...
        transCat = np.loadtxt(dir+jdanUse[ff]+"_"+targname+"_"+filt+"_t_1106r2.dat")
        ...
        np.savetxt(dir+jdanUse[ff] + "_"+targname+"_"+filt+"_at_1106r2.dat", cat, fmt="%d %1.7f %1.7f %1.4f %1.4f %1.4f %1.3f %1.4f %d %1.4f %1.4f %1.6f %1.6f", header=header)
