...
# matched_w_MagsPos2705.dat
    match = np.loadtxt(dir+"matched_w_MagsPos2705.dat")
    master = np.loadtxt(dir+"matched_w_MagsPos2705.dat")
    ...
    for ff in range(len(jdanUse)):
        ...
        all = np.loadtxt(dir+jdanUse[ff]+"_"+targname+"_"+filt+"_at_2705.dat")

        outname = jdanUse[ff]+"_"+targname+"_"+filt+"_t_2705r2.dat"
...
def addTranscols(targname,filt,dir='catRawMags1305/catDir/'):
    ...
    for ff in range(len(jdanUse)):
        ...
        transCat = np.loadtxt(dir+jdanUse[ff]+"_"+targname+"_"+filt+"_t_2705r2.dat")
        ...
        np.savetxt(dir+jdanUse[ff] + "_"+targname+"_"+filt+"_at_2705r2.dat", cat, fmt="%d %1.7f %1.7f %1.4f %1.4f %1.4f %1.3f %1.4f %d %1.4f %1.4f %1.6f %1.6f", header=header)
