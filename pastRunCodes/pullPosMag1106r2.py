...
master= np.genfromtxt(dir+'drcFLCidx_1106_f606wr2.dat')
...
header= 'RA DEC flags c_star mag1 mag2 mag3 mag4 xr1 yr1 xt1 yt1 xDRC_trans yDRC_trans xDRC_mat yDRC_mat magDRC id_cat'

np.savetxt(dir+'matchedFLCdrc1106r2.dat',outArr,header=header)
