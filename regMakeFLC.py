...
file = np.genfromtxt(workDir+'matched_w_MagsPos2705r3.dat')
...
np.savetxt(workDir+'flc100source_f814w_1706.dat',file_100[:,[RA,DEC,xt1,yt1,id]],fmt='%1.7f  %1.7f  %1.5f %1.5f %d')
