...
def linPSFTrans(targname,dir='photUtils0820/'):
    ...
    file = np.genfromtxt(dir+'drcPSFref_'+targname+'_pU.dat',names=True)
    fileCat = np.genfromtxt(dir+'drcPSFref_'+targname+'_pU.dat')
    ...
    outName = dir + targname + "_PSFpuTrans"
    ...
    new_match[:,0],new_match[:,1],master_arr[:,0], master_arr[:,1],label_1='Original in F814W',label_2='New in PSF 2 PU',label_3='Original in PU',outname=outName+'_matchCheck')
...
linPSFTrans('HOROLOGIUM-I',dir='photUtils0820/')
